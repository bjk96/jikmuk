...
public class delibary_start extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    Button btn;
    Toolbar menuToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delibary_start);
        btn = findViewById( R.id.btn_start );
        edit_name = (EditText)findViewById(R.id.txt_deliary_name);
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.btn_start:
                Intent intent = new Intent(this, delibary_main.class);
                startActivity(intent);
                /*finish();*/
                break;
        }
