...
public class member_order_menu_select extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_order_menu_select);
    ...
    public void onClick(View view){
        switch (view.getId()) {
            ...
            case R.id.btn_bucket:
                Intent intent2 = new Intent( this, member_bucket.class );
