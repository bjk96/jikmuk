...
public class food_add_pointReceipt_model implements Serializable {
    String beforePoint;//
    String usingPoint;//
    String afterPoint;//
    String uid;//
    ...
    public food_add_pointReceipt_model(String bank, String accountHolder, String accountNumber, String beforePoint, String usingPoint, String afterPoint, String uid, String type, Object cashoutTime){
    ...
    public food_add_pointReceipt_model(String beforePoint, String usingPoint, String afterPoint, String uid, Object timestamp, Object ordertime, String type, String oderer_uid, String stadium, String shop){
        this.beforePoint = beforePoint;//
        this.usingPoint = usingPoint;//
        this.afterPoint = afterPoint;//
        this.uid = uid;//
